...
from api.productlog.crud import get_all_product_details, get_all_product_inventory
from models.productlogs.pydantic import ProductDetailsSchema, ProductInventorySchema
