...
class AccountPayloadSchema(BaseModel):
    ...
    email: str = EmailStr()
    list_of_roles: Optional[List[Role]] = None
    ...
    def validate_email(cls, value: EmailStr) -> EmailStr:
        """Validate the email address using email_validator."""
        try:
    ...
    def validate_roles(cls, value: Role) -> Role:
        """Validate that each role is a valid Role enum member."""
...
class LoginSchema(BaseModel):
    ...
    def validate_username(cls, value: str) -> str:
        """Validate that the username is alphanumeric and at least 3 characters long."""
