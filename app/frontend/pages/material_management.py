...
@prod_router.page('/material-management')
def material_management_page():

    # Main content area with Element UI styling
    # ui.label('物料管理').classes('text-2xl font-bold mb-6 text-gray-800')
    ...
    with ui.card().classes('w-full mb-6 shadow-sm'):
        with ui.row().classes('w-full justify-between items-center'):
            ...
            with ui.row().classes('gap-2'):
                ui.button('物料审核', icon='assignment_turned_in').disable() # 展示时暂时禁用，后续修改
